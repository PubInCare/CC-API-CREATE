...
router.post(`/api/auth/register`, [checkValidation], (req, res) =>  {
...
router.post(`/api/auth/login`, [checkValidationLogin], (req, res) => {
     // mengecek ke middleware apakah kondisi validasi terpenuhi atau tidak
     const errors = validationResult(req);
...
router.post('/api/v1/auth/logout',auth.authLogout) 
